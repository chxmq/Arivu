...
(function (global) {
  ...
  const DICT = {
    ...
    "sub.sentinels": { en: "Kaavu boxes linked to elder predictions · Kaalam validation", ml: "മുതിർന്നവർ പ്രവചനങ്ങളുമായി ബന്ധപ്പെട്ട കാവ് പെട്ടികൾ", kn: "ಹಿರಿಯರ ಭವಿಷ್ಯಗಳಿಗೆ ಜೋಡಿಸಿದ ಕಾವು ಪೆಟ್ಟಿಗೆಗಳು", ta: "மூத்தோர் கணிப்புகளுடன் இணைக்கப்பட்ட காவு பெட்டிகள்", hi: "बुजुर्ग भविष्यवाणियों से जुड़े कावु बॉक्स" },
